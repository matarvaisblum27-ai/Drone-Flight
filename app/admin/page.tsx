...
function ConfirmDialog({ message, onConfirm, onCancel }: {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-slate-800 border border-red-900/40 rounded-2xl p-6 w-full max-w-sm shadow-2xl">
        <div className="flex items-start gap-4 mb-5">
          ...
          <div>
            <h3 className="text-sm font-semibold text-white leading-snug">{message}</h3>
            <p className="text-xs text-red-400/80 mt-1.5">פעולה זו אינה ניתנת לביטול.</p>
          </div>
        </div>
...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {confirmId && (
        <ConfirmDialog
          message="האם אתה בטוח שברצונך למחוק טיסה זו?"
      ...
      {confirmPilotId && (
        <ConfirmDialog
          message="האם אתה בטוח שברצונך למחוק טייס זה?"
      ...
      {confirmDeleteDroneId && (
        <ConfirmDialog
          message="האם אתה בטוח שברצונך למחוק רחפן זה?"
      ...
      {confirmBatteryId && (
        <ConfirmDialog
          message="האם אתה בטוח שברצונך למחוק סוללה זו?"
